...
tau_event = num.zeros(1, dtype=int)
tau_lum = num.zeros(1, dtype=int)
tau_run = num.zeros(1, dtype=int)
...
tau_tree.Branch('tau_event', tau_event, 'tau_event/I')
tau_tree.Branch('tau_lum', tau_lum, 'tau_lum/I')
tau_tree.Branch('tau_run', tau_run, 'tau_run/I')
...
for event in events:
    ...
    lum = event.eventAuxiliary().id().luminosityBlock()
