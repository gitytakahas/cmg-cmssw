...
#    for ii in visparticles:
#        print ii.pdgId(), ii.pt()
...
def p4sumvis2(particles):
    ...
    for pp in visparticles:

        _vector_ = ROOT.TLorentzVector()
        _vector_.SetPtEtaPhiM(pp.pt(), 
                              pp.eta(),
                              pp.phi(), 
                              pp.mass())
...
def returnGenDecayMode(TauDaughters):
    ...
    _photon_ = [p for p in TauDaughters if abs(p.pdgId())==22 and p.pt() > 0.5]
    ...
    if nmuon==1: return 'muon',-1,nphoton, npion, _photon_
    elif nelectron == 1 : return 'electron',-2,nphoton, npion, _photon_

    
    if npion==1:
        if nphoton == 0 : return 'oneProng0Pi0',0,nphoton, npion, _photon_
        elif nphoton == 2 : return 'oneProng1Pi0',1,nphoton, npion, _photon_
        elif nphoton == 4 : return 'oneProng2Pi0',2,nphoton, npion, _photon_
        elif nphoton == 6 : return 'oneProng3Pi0',3,nphoton, npion, _photon_
        elif nphoton == 8 : return 'oneProng4Pi0',4,nphoton, npion, _photon_
        else: return 'oneProngOther',-3,nphoton, npion, _photon_
    elif npion==3:
        if nphoton == 0 : return 'threeProng0Pi0', 10,nphoton, npion, _photon_
        elif nphoton == 2 : return 'threeProng1Pi0', 11,nphoton, npion, _photon_
        elif nphoton == 4 : return 'threeProng2Pi0', 12,nphoton, npion, _photon_
        elif nphoton == 6 : return 'threeProng3Pi0', 13,nphoton, npion, _photon_
        else: return 'threeProngOther', -4,nphoton, npion, _photon_
    else:
        return 'rare', -5,nphoton, npion, _photon_
