...
if __name__ == '__main__':
    ...
    tree.Branch('tau_phi_old', tau_phi_old, 'tau_phi_old/D')
    tree.Branch('tau_ciso_old', tau_ciso_old, 'tau_ciso_old/D')
    tree.Branch('tau_niso_old', tau_niso_old, 'tau_niso_old/D')
    ...
    tree.Branch('tau_phi_new', tau_phi_new, 'tau_phi_new/D')
    tree.Branch('tau_ciso_new', tau_ciso_new, 'tau_ciso_new/D')
    tree.Branch('tau_niso_new', tau_niso_new, 'tau_niso_new/D')
    ...
    s_dynamic = shelve.open('save_dynamic.db')
...
#        if value['nweight'] > 2: continue
    ...
    hgcor.GetYaxis().SetTitle('Standard reco. : #tau_{h} mode')
