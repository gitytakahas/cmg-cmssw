...
#                                    MinY = cms.double(0.0),
#                                    MinZ = cms.double(0.0),
                                    MaxX = cms.double(0.244),
                                    MaxY = cms.double(0.3928),
                                    MaxZ = cms.double(0.3819),
                                    MinX = cms.double(0.244),
                                    MinY = cms.double(0.3928),
                                    MinZ = cms.double(0.3819),
...
process.generator = cms.EDProducer("Pythia6PtGun",
    ...
    PythiaParameters = cms.PSet(
        ...
        pythiaTauJets = cms.vstring(
            ...
            'MDME(92,1)=0      ! no tau->muon',
            'MDME(93,1)=0      ! no tau->muon',
            'MDME(94,1)=0      ! no tau->muon',
            ...
            'MDME(109,1)=1      ! no tau->muon',
            'MDME(110,1)=0      ! no tau->muon',
