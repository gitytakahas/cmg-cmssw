...
aliases = {
    ...
    '/JJHiggs0MToTauTau_M.*START53.*':'Higgs0MGGH125',
    '/JJHiggs0PToTauTau_M.*START53.*':'Higgs0PGGH125',
#    '/JJHiggs0PToTauTau_M.*START53.*':'HiggsGGH',
#    '/JJHiggs0MToTauTau.*':'HiggsGGH',
#    '/JJHiggs0PToTauTau_M-125.*START53.*':'HiggsGGH',
...
MC_list = copy.copy( higgs_ggh_spin )
...
connect( [Higgs0PGGH125], '%0P%TauMu_Yuta_Jan20_NOM', 'tauMu.*root', aliases, cache=True, verbose=False)
connect( [Higgs0MGGH125], '%0M%TauMu_Yuta_Jan20_NOM', 'tauMu.*root', aliases, cache=True, verbose=False)

#connect( [Higgs0PGGH125], '%0P%PAT_CMG_V5_16_0', 'cmg.*root', aliases, cache=True, verbose=False)
#connect( [Higgs0MGGH125], '%0M%PAT_CMG_V5_16_0', 'cmg.*root', aliases, cache=True, verbose=False)


#import pdb; pdb.set_trace()
#connect( [HiggsGGH125], '%PAT_CMG_V5_16_0', 'cmgTuple_.*root', aliases, cache=True, verbose=False)
