...
#from CMGTools.H2TauTau.proto.samples.run2012.triggers_emuTau import data_triggers, mc_triggers, embed_triggers
from CMGTools.H2TauTau.proto.samples.run2012.triggers_eleMu import data_triggers, mc_triggers, embed_triggers
#/VBF_HToTauTau_M-125_8TeV-powheg-pythia6/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM/V5_B/PAT_CMG_V5_16_0/EMuTau_Yuta_Feb12

#/eos/cms/store/cmst3/user/ytakahas/CMG/LFV/ggH/AOD/PAT_CMG_V5_18/PAT_CMG_V5_18_prod/EleMu_Yuta_4Jul

aliases = {
#    '/LFV/ggH*':'HiggsGGH125',
#    '/LFV/qqH*':'HiggsVBF125',
    '/VBF_HToTauMu.*START53.*':'HiggsVBF',
    '/GluGluToHToTauMu.*START53.*':'HiggsGGH',
...
MC_list.extend( mc_higgs_ggh_125 ) ## for mumuTau
...
connect( allsamples, '%EleMu_Yuta_6Jul', 'muEle_fullsel.*root', aliases, cache=True, verbose=False)
#connect( mc_higgs_ggh_125, '%EleMu_Yuta_4Jul', 'muEle_.*root', aliases, cache=True, verbose=False)
