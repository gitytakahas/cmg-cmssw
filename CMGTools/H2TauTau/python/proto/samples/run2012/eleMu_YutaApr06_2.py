...
MC_list = copy.copy( mc_higgs_vbf_125 )
MC_list.extend( mc_higgs_ggh_125 )
allsamples = copy.copy(MC_list)
...
ydata_runA = [data_Run2012A]
connect(ydata_runA, '%EMuTau_Yuta_Feb21', 'muEle_.*root', aliases, cache=True, verbose=False)

ymc_vbf = [HiggsVBF125]
connect(ymc_vbf, '%EMuTau_Yuta_Feb21', 'muEle_.*root', aliases, cache=True, verbose=False)
...
connect(ymc_tt, '%EleMu_Yuta_Apr3', 'muEle_.*root', aliases, cache=True, verbose=False)
connect(ymc_w, '%EleMu_Yuta_Apr3', 'muEle_.*root', aliases, cache=True, verbose=False)
