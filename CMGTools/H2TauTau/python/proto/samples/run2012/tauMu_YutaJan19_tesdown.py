...
connect( [Higgs0PGGH125], '%0P%TauMu_Yuta_Jan20_TESDOWN', 'tauMu.*root', aliases, cache=True, verbose=False)
connect( [Higgs0MGGH125], '%0M%TauMu_Yuta_Jan20_TESDOWN', 'tauMu.*root', aliases, cache=True, verbose=False)
