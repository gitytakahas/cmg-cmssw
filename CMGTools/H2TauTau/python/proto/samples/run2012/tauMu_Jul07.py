...
#connect( allsamples, '%TAUMU_SVFitVEGAS_Jul26_steggema', 'tauMu.*root', aliases, cache=True, verbose=False)
connect( allsamples, '%TauMu_Yuta_6Jul', 'tauMu_fullsel.*root', aliases, cache=True, verbose=False)
