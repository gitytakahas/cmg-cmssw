...
#channel    = 'tau-mu' # 'tau-mu' #'di-tau' 'all' 'tau-ele' 'mu-ele'
channel    = 'mu-ele' # 'tau-mu' #'di-tau' 'all' 'tau-ele' 'mu-ele'
jetRecalib = False
useCHS     = False 
newSVFit   = True
tauScaling = 0
...
#dataset_name  = '/tblv_H126to2tau_q_YtMinus1-madgraph-pythia6//Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM/V5_B/PAT_CMG_V5_16_0/EMuTau_Yuta_Feb6'
...
if isEmbedded:
    ...
    if channel == 'ele-mu':
        ...
        process.muElePath.insert(-1, process.embeddingKineReweightSequenceRECembedding)
...
if not runOnMC :
    if not isEmbedded :
      ...
      process.muElePath.remove( process.cmgMuEleCor )                  ## boh
      process.cmgMuEleTauPtSel.src = cms.InputTag('mvaMETMuEle')           ## boh
    ...
    process.muElePath.remove( process.genSequence )
...
if jetRecalib: 
    ...
    process.muElePath.insert(0, process.cmgPFJetSel)
    ...
    process.muElePath.insert(0, process.cmgPFJetSelCHS)
