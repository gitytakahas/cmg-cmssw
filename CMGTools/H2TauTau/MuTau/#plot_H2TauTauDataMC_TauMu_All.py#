...
from ROOT import kPink, TH1, TPaveText, TPad, Double
...
#    osQCD.Group('Higgs 125', ['HiggsVBF125', 'HiggsGGH125', 'HiggsVH125'])
    osQCD.Group('Higgs 125', ['HiggsVBF125', 'HiggsGGH125', 'HiggsWH125', 'HiggsZH125','HiggsTTH125'])
...
if __name__ == '__main__':
    ...
    for line in qcdfile:
        comp = line.split(' ')
        print 'QCD yield is', comp[1]
        qyield = Double(comp[1])

    print 'QCD yield = ', qyield
...
#    incQCDYield = 4481.0 # Sep19 with pt>30
    incQCDYield = Double(qyield) # Sep19 with pt>30
