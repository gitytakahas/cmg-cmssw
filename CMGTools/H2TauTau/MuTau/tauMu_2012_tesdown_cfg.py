...
TauTurnOn = '/afs/cern.ch/work/y/ytakahas/TauTrigger/CMSSW_5_3_14/src/CMGTools/H2TauTau/MuTau/compMuTauL1Thresholds_L1UpgradeTau4x4_efficiencyVsOfflineTauPt_fit.root'
OldTauTurnOn = '/afs/cern.ch/work/y/ytakahas/TauTrigger/CMSSW_5_3_14/src/CMGTools/H2TauTau/MuTau/compMuTauL1Thresholds_L1TauOrJet_efficiencyVsOfflineTauPt_fit.root'
TauTurnOn21 = '/afs/cern.ch/work/y/ytakahas/TauTrigger/CMSSW_5_3_14/src/CMGTools/H2TauTau/MuTau/compMuTauL1Thresholds_L1UpgradeTau2x1_efficiencyVsOfflineTauPt_fit.root'
...
TauTriggerWeighter = cfg.Analyzer(
    'TauTriggerWeighter',
    turnon = TauTurnOn,
    oldturnon = OldTauTurnOn,
    turnon21 = TauTurnOn21
    )
...
from CMGTools.H2TauTau.proto.samples.run2012.tauMu_down_JanJul22 import *
...
if test==1:
    ...
    selectedComponents = [s for s in selectedComponents if '125' in s.name]
