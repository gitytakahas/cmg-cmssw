...
python HiggsAnalysis/HiggsToTauTau/scripts/doSM.py --drop-list auxiliaries/pruning/uncertainty-pruning-drop-130924-sm.txt --config HiggsAnalysis/HiggsToTauTau/limits_e.config --update-all 125
