...
variables = {
    ...
    'bdt_muon_dB3D': {'nbin':nbin, 'xtitle':'log(abs(muon MVA dB3D))', 'xmin':-15, 'xmax':0.},
    'bdt_muon_dz': {'nbin':nbin, 'xtitle':'log(abs(muon dz))', 'xmin':-15, 'xmax':0},
    'bdt_muon_dxy': {'nbin':nbin, 'xtitle':'log(abs(muon dxy))', 'xmin':-15, 'xmax':0},
    ...
    'bdt_electron_pdg': {'nbin':40, 'xtitle':'electron PDG', 'xmin':-20, 'xmax':20},
    'bdt_electron_mva_neu_iso': {'nbin':nbin, 'xtitle':'electron MVA neutral iso', 'xmin':0, 'xmax':1},
    'bdt_electron_mva_ch_iso': {'nbin':nbin, 'xtitle':'electron MVA charged iso', 'xmin':0, 'xmax':1},
    'bdt_electron_dB3D': {'nbin':nbin, 'xtitle':'log(abs(electron dB3D)) (cm)', 'xmin':-15, 'xmax':0},
    'bdt_electron_dz': {'nbin':nbin, 'xtitle':'log(abs(electron dz))', 'xmin':-15, 'xmax':0},
    'bdt_electron_dxy': {'nbin':nbin, 'xtitle':'log(abs(electron dxy))', 'xmin':-15, 'xmax':0},
    'bdt_electron_mva_csv': {'nbin':nbin, 'xtitle':'electron MVA CSV', 'xmin':0, 'xmax':1},
    'bdt_electron_mva_jet_dr': {'nbin':nbin, 'xtitle':'electron MVA jet dR', 'xmin':0, 'xmax':0.4},
...
#    'ttbar':{'selection':'bdt_evt_processid>=4 && bdt_evt_processid<=5', 'col':col_tt, 'order':5},
