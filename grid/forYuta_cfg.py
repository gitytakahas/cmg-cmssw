...
#process.skimOutputModule.outputCommands.append('drop *_*_*_*')
#process.skimOutputModule.outputCommands.append('keep *_offlinePrimaryVertices_*_*')
#process.skimOutputModule.outputCommands.append('keep *_genParticles_*_*')
#process.skimOutputModule.outputCommands.append('keep *_hpsPFTauProducer_*_*')
#process.skimOutputModule.outputCommands.append('keep *_hpsPFTauMVA3IsolationNeutralIsoPtSum_*_*')
#process.skimOutputModule.outputCommands.append('keep *_particleFlowRecHitECAL_*_*')
#process.skimOutputModule.outputCommands.append('keep *_particleFlowCluster*_*_*')
#process.skimOutputModule.outputCommands.append('keep recoPFClusters*_*_*_*')
#process.skimOutputModule.outputCommands.append('keep *_ak4PFJets*_*_*')
